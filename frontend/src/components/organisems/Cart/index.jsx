      ...
      >
            ...
            <li className="flex pt-5 pb-8 border-b border-gray-200" key={index}>
              ...
              <div className="flex flex-col w-full ">
                <div className="flex text-md text-[#213775]">
                  ...
                  <p className="font-semibold text-md">Rp{item.price.toLocaleString("id-ID")}</p>
                </div>
                <div className=" flex m-2 " >
                    ...
                    <div onClick={() => onClickRemoveFromCart(index)} className="ml-5 text-xs my-auto text-gray-500 cursor-pointer">REMOVED</div>
                </div>
              </div>
            </li>
          ))}
        ...
        <hr />
          <div className="p-11 text-[#213875] bg-white">
            ...
            <div>
              <p onClick={onClickShowDiscount} className={`font-semibold text-sm tracking-wide cursor-pointer ${showDiscount ? 'hidden' : ''}`}>Use a dicount code</p>
              <div className={`grid grid-rows-1 grid-flow-col gap-1 mt-8 ${showDiscount ? '' : 'hidden'}`}>
                <input type="text" placeholder="Dou you have a dicsount code?" className="col-span-2 p-3 w-full border border-gray-400"/>
