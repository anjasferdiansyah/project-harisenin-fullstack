  ...
  return (
    <div className=" p-4 shadow-md rounded-t-md">
      ...
      <div className="text-[#213875]">
        <Link
          className="relative py-4 hover:text-white before:block before:absolute before:top-0 before:left-0 before:w-full before:h-full before:bg-[#213875]  before:scale-x-0 hover:before:scale-x-[100%] before:origin-right hover:before:origin-left before:transition-transform before:duration-[700ms] before:ease-[cubic-bezier(0.19,1,0.22,1)] before:delay-0 before:z-0"
          to={`/${id}`}
        >
          <div className="hover:ml-5">
            <p className="relative my-2 text-xl">{title}</p>
            <p className="relative text-md font-semibold">{price}</p>
          </div>
        </Link>
      </div>
    </div>
