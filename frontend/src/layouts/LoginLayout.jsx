    ...
    <>
      ...
      <main className="flex flex-col md:flex-row h-screen text-[#213775] items-center justify-center font-futura">
        <div className="w-full items-center justify-center p-5 h-[50%]">
          <h1 className="text-3xl pb-8 font-extrabold md:text-5xl">
            Customer Login
          </h1>
        ...
        <div className="bg-[#dcf6da] w-full h-[50%] md:h-full flex flex-col items-center justify-center p-5">
          <h1 className="text-3xl pb-8 font-extrabold md:text-5xl w-full">
            New Customer
          </h1>
          <p className="w-full text-sm md:text-md font-medium">
            Creating an account has many advantages: a faster ordering process,
